...
import ut.edu.auth.dto.response.MessageResponse; // DTO tùy biến: chuẩn hóa response trả về (success, message, data)
import ut.edu.auth.exception.*; // Import các exception tùy biến trong module auth (EmailAlreadyExistsException, UserNotFoundException, ...)
