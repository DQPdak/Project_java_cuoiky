...
package ut.edu.auth.controller;
...
import ut.edu.auth.dto.request.*; // DTO nhận dữ liệu từ client: RegisterRequest, LoginRequest, ...
import ut.edu.auth.dto.response.AuthResponse; // DTO dữ liệu auth trả về: accessToken, refreshToken, userInfo
import ut.edu.auth.dto.response.MessageResponse; // DTO bao bọc phản hồi: success, message, data
import ut.edu.auth.service.AuthService; // Service chứa logic nghiệp vụ cho auth
