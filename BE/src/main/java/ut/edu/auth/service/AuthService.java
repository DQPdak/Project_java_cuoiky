...
import ut.edu.auth.dto.request.*;
import ut.edu.auth.dto.response.AuthResponse;
import ut.edu.auth.dto.response.UserResponse;

// Entity và enum của miền nghiệp vụ
import ut.edu.auth.entity.PasswordResetToken;
import ut.edu.auth.entity.RefreshToken;
import ut.edu.auth.entity.User;
import ut.edu.auth.entity.enums.AuthProvider;
import ut.edu.auth.entity.enums.UserStatus;

// Exception tuỳ chỉnh của ứng dụng
import ut.edu.auth.exception.*;

// Repository và provider JWT
import ut.edu.auth.repository.PasswordResetTokenRepository;
import ut.edu.auth.repository.UserRepository;
import ut.edu.auth.security.JwtTokenProvider;
