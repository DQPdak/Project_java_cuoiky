      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="h-40 bg-gradient-to-r from-slate-900 via-indigo-900 to-blue-900 flex items-end px-10 pb-6">
           <div className="flex items-center gap-6 translate-y-2">
              ...
              <div>
                ...
                <p className="text-indigo-200 font-bold text-lg">{job.companyName}</p>
              </div>
           </div>
        </div>
        ...
        <div className="pt-16 pb-8 px-10 grid grid-cols-1 md:grid-cols-3 gap-6 bg-gray-50/50 border-b border-gray-100">
          <div className="flex items-center gap-4 p-4 bg-white rounded-2xl shadow-sm border border-gray-100">
            ...
            <div>
              <p className="text-[10px] text-gray-400 uppercase font-black tracking-widest">Lương</p>
          ...
          <div className="flex items-center gap-4 p-4 bg-white rounded-2xl shadow-sm border border-gray-100">
            ...
            <div>
              <p className="text-[10px] text-gray-400 uppercase font-black tracking-widest">Địa điểm</p>
              <p className="font-black text-gray-900 truncate" title={job.location}>{job.location}</p>
            </div>
          </div>
          <div className="flex items-center gap-4 p-4 bg-white rounded-2xl shadow-sm border border-gray-100">
            <div className="p-3 bg-orange-50 text-orange-600 rounded-xl"><Calendar size={24}/></div>
            <div>
              <p className="text-[10px] text-gray-400 uppercase font-black tracking-widest">Hạn nộp</p>
              <p className="font-black text-gray-900">
                {job.expiryDate ? new Date(job.expiryDate).toLocaleDateString("vi-VN") : "Vô thời hạn"}
              </p>
            </div>
          </div>
        </div>
