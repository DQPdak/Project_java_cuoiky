  ...
  return (
    <div className="w-full max-w-md mx-auto p-6 bg-white rounded-lg shadow-md my-10">
      ...
      <form className="space-y-4" onSubmit={handleRegister}>
        ...
        {/* --- Chọn vai trò --- */}
        <div>
          <label htmlFor="userRole" className="block text-sm font-medium text-gray-700">Bạn là?</label>
          <select id="userRole" name="userRole"
            className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            onChange={handleChange} value={formData.userRole}
          >
      ...
      <p className="mt-6 text-center text-sm text-gray-600">
        Đã có tài khoản? <Link href="/login" className="font-medium text-blue-600 hover:text-blue-500">Đăng nhập ngay</Link>
      </p>
    </div>
  );
}