      ...
      <form className="space-y-6" onSubmit={handleLogin}>
        ...
        <div>
          ...
          <div className="mt-1 relative">
            <input 
              ...
              required
              className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm pr-10" // pr-10 để tránh text bị đè lên icon
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-sm">
            <a href="/forgot-password" className="font-medium text-blue-600 hover:text-blue-500">Quên mật khẩu?</a>
          </div>
        </div>
      ...
      <div className="mt-6">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white text-gray-500">Hoặc tiếp tục với tư cách người ứng tuyển</span>
          </div>
        </div>
        <div className="mt-4">
           <GoogleLoginButton />
